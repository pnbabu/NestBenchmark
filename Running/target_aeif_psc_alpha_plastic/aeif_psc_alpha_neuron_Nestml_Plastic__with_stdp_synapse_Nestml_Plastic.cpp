...
template <> void RecordablesMap<aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>::create()
  {
...
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::Buffers_::Buffers_(aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &n):
  logger_(n)
...
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::Buffers_::Buffers_(const Buffers_ &, aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic(const aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic& __n):
...
void
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::register_stdp_connection( double t_first_read, double delay )
{
...
void
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::get_history__( double t1,
  double t2,
...
void
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::set_spiketime( nest::Time const& t_sp, double offset )
{
...
S_.ode_state[State_::post_trace__for_stdp_synapse_Nestml_Plastic] += 1;
    ...
    **/
    ...
    last_spike_ = t_sp_ms;
    history_.push_back( histentry__aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic( last_spike_
...
void
aeif_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
