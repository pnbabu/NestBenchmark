// #define DEBUG 1
/*
 *  aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic.cpp
 *
...
#include "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic.h"

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic> aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::recordablesMap_;
namespace nest
{
  ...
  template <>
  void RecordablesMap<aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic>::create()
  {
    // add state variables to recordables map
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_V_m, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_V_m);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_w, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_w);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_refr_t, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_refr_t);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_post_trace__for_stdp_synapse_NESTML_Plastic, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_g_inh__X__inh_spikes, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_g_inh__X__inh_spikes);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_g_inh__X__inh_spikes__d, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_g_inh__X__inh_spikes__d);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_g_exc__X__exc_spikes, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_g_exc__X__exc_spikes);
    insert_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_names::_g_exc__X__exc_spikes__d, &aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_g_exc__X__exc_spikes__d);

    // Add vector variables
  }
}
std::vector<std::tuple<int, int>> aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::rport_to_nestml_buffer_idx =
    {

        {aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::EXC_SPIKES, aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::INH_SPIKES},
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic's constructor.
// ---------------------------------------------------------------------------

aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::Parameters_::Parameters_()
{
}

aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::State_::State_()
{
}
...
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::Buffers_::Buffers_(aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic &n) : logger_(n), spike_inputs_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_inputs_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), spike_input_received_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_input_received_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), __s(nullptr), __c(nullptr), __e(nullptr)
{
  // Initialization of the remaining members is deferred to init_buffers_().
}

aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::Buffers_::Buffers_(const Buffers_ &, aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic &n) : logger_(n), spike_inputs_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_inputs_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), spike_input_received_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_input_received_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), __s(nullptr), __c(nullptr), __e(nullptr)
{
  // Initialization of the remaining members is deferred to init_buffers_().
}
...
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic() : ArchivingNode(), P_(), S_(), B_(*this)
{
...
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic(const aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic &__n) : ArchivingNode(), P_(__n.P_), S_(__n.S_), B_(__n.B_, *this)
{
...
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::~aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic()
{
...
// ---------------------------------------------------------------------------
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::calibrate_time(const nest::TimeConverter &tc)
{
  LOG(nest::M_WARNING,
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::init_state_internal_()" << std::endl;
#endif
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::init_buffers_()
{
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::init_buffers_()" << std::endl;
#endif
  // spike input buffers
  ...
  // B_.__sys.function = aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_dynamics; // will be set just prior to the call to gsl_odeiv_evolve_apply()
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms(); // do not remove, this is necessary for the resolution() function
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::pre_run_hook()
{
  B_.logger_.init();
...
extern "C" inline int aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_dynamics(double __time, const double ode_state[], double f[], void *pnode)
{
  typedef aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::State_ State_;
  // get access to node so we can almost work as in a member function
  assert(pnode);
  const aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic &node = *(reinterpret_cast<aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic *>(pnode));

  // ode_state[] here is---and must be---the state vector supplied by the integrator,
  // not the state vector in the node, node.S_.ode_state[].
  f[State_::V_m] = (node.P_.Delta_T * node.P_.g_L * std::exp(((-node.P_.V_th) + std::min(ode_state[State_::V_m], node.P_.V_peak)) / node.P_.Delta_T) + node.P_.I_e + node.B_.I_stim_grid_sum_ - node.P_.g_L * ((-node.P_.E_L) + std::min(ode_state[State_::V_m], node.P_.V_peak)) + 1.0 * ode_state[State_::g_exc__X__exc_spikes] - 1.0 * ode_state[State_::g_inh__X__inh_spikes] - ode_state[State_::w]) / node.P_.C_m;
...
extern "C" inline int aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_dynamics_post_trace__for_stdp_synapse_NESTML_Plastic(double __time, const double ode_state[], double f[], void *pnode)
{
  typedef aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::State_ State_;
  // get access to node so we can almost work as in a member function
  assert(pnode);
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::update(nest::Time const &origin, const long from, const long to)
{

  const double __resolution = nest::Time::get_resolution().get_ms(); // do not remove, this is necessary for the resolution() function

#ifdef DEBUG
  std::cout << "In aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::update: t = " << __resolution << std::endl;
#endif
  ...
  for (long lag = from; lag < to; ++lag)
  {
    ...
    else
    {
      ...
      // analytic solver: integrating state variables (first step): g_inh__X__inh_spikes, g_inh__X__inh_spikes__d, g_exc__X__exc_spikes, g_exc__X__exc_spikes__d, post_trace__for_stdp_synapse_NESTML_Plastic,
      ...
      double __t = 0;
      B_.__sys.function = aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic_dynamics;
      ...
      // analytic solver: integrating state variables (second step): g_inh__X__inh_spikes, g_inh__X__inh_spikes__d, g_exc__X__exc_spikes, g_exc__X__exc_spikes__d, post_trace__for_stdp_synapse_NESTML_Plastic,
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::handle(nest::DataLoggingRequest &e)
{
  B_.logger_.handle(e);
}

void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if (nestml_buffer_idx == aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::PORT_NOT_AVAILABLE)
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::handle(nest::CurrentEvent &e)
{
  assert(e.get_delay_steps() > 0);
...
inline double
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_spiketime_ms() const
{
  return last_spike_;
}

void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::register_stdp_connection(double t_first_read, double delay)
{
  ...
  for (std::deque<histentry__aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic>::iterator runner = history_.begin();
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_history__(double t1,
                                                                                           double t2,
                                                                                           ...
                                                                                           std::deque<histentry__aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic>::iterator *finish)
{
  *finish = history_.end();
  ...
  std::deque<histentry__aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic>::reverse_iterator runner = history_.rbegin();
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::set_spiketime(nest::Time const &t_sp, double offset)
{
  ...
  if (n_incoming_)
  {
    ...
    last_spike_ = t_sp_ms;
    history_.push_back(histentry__aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic(last_spike_, get_post_trace__for_stdp_synapse_NESTML_Plastic(), 0));
  }
  else
  {
    last_spike_ = t_sp_ms;
...
void aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
...
double
aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic(double t, const bool before_increment)
{
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: getting value at t = " << t << std::endl;
#endif
  ...
  {
#ifdef DEBUG
    std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: \thistory empty, returning initial value = " << post_trace__for_stdp_synapse_NESTML_Plastic__iv << std::endl;
#endif
  ...
  while (i >= 0)
  {
    ...
    {
#ifdef DEBUG
      std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: \tspike occurred at history[i].t_ = " << history_[i].t_ << std::endl;
#endif
...
#ifdef DEBUG
      std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: \treturning " << S_.ode_state[State_::post_trace__for_stdp_synapse_NESTML_Plastic] << std::endl;
#endif
...
#ifdef DEBUG
    std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: \ttrace requested at exact time of history entry 0, returning " << S_.ode_state[State_::post_trace__for_stdp_synapse_NESTML_Plastic] << std::endl;
#endif
...
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_NESTML_Plastic__with_stdp_synapse_NESTML_Plastic::get_post_trace__for_stdp_synapse_NESTML_Plastic: \tfall-through, returning initial value = " << post_trace__for_stdp_synapse_NESTML_Plastic__iv << std::endl;
#endif
