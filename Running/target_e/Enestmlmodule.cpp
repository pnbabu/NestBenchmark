...
Enestmlmodule Enestmlmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

Enestmlmodule::Enestmlmodule()
{
#ifdef LINKED_MODULE
...
const std::string
Enestmlmodule::name() const
{
  return std::string("Enestmlmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
Enestmlmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<iaf_psc_exp_neuron_Nestml>("iaf_psc_exp_neuron_Nestml");
} // Enestmlmodule::init()