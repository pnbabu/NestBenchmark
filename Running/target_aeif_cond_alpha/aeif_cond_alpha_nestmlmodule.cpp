...
/*
*  aeif_cond_alpha_nestmlmodule.cpp
*
...
#include "aeif_cond_alpha_nestmlmodule.h"
...
aeif_cond_alpha_nestmlmodule aeif_cond_alpha_nestmlmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

aeif_cond_alpha_nestmlmodule::aeif_cond_alpha_nestmlmodule()
{
#ifdef LINKED_MODULE
...
const std::string
aeif_cond_alpha_nestmlmodule::name() const
{
  return std::string("aeif_cond_alpha_nestmlmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
aeif_cond_alpha_nestmlmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<aeif_cond_alpha_neuron_Nestml>("aeif_cond_alpha_neuron_Nestml");
    nest::kernel().model_manager.register_node_model<aeif_cond_alpha_neuron_Nestml>("aeif_cond_alpha_neuron_Nestml");
} // aeif_cond_alpha_nestmlmodule::init()