...
#include "aeif_psc_alpha_neuron_Nestml_Plastic_Optimized.h"

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized> aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized>::create()
  {
    // add state variables to recordables map
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_V_m, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_V_m);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_w, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_w);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_refr_t, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_refr_t);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_g_inh__X__inh_spikes);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes__d, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_g_inh__X__inh_spikes__d);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_g_exc__X__exc_spikes);
   insert_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes__d, &aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::get_g_exc__X__exc_spikes__d);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::rport_to_nestml_buffer_idx =
{
  
  { aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::EXC_SPIKES, aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::INH_SPIKES },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of aeif_psc_alpha_neuron_Nestml_Plastic_Optimized's constructor.
// ---------------------------------------------------------------------------

aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::Parameters_::Parameters_()
{
}

aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::State_::State_()
{
}
...
aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::Buffers_::Buffers_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized &n):
  logger_(n)
...
aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::Buffers_::Buffers_(const Buffers_ &, aeif_psc_alpha_neuron_Nestml_Plastic_Optimized &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized():ArchivingNode(), P_(), S_(), B_(*this)
{
...
aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized(const aeif_psc_alpha_neuron_Nestml_Plastic_Optimized& __n):
...
aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::~aeif_psc_alpha_neuron_Nestml_Plastic_Optimized()
{
...
// ---------------------------------------------------------------------------
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::init_state_internal_()" << std::endl;
#endif
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::init_buffers_()
{
#ifdef DEBUG
  std::cout << "aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::init_buffers_()" << std::endl;
#endif
  // spike input buffers
  ...
  // B_.__sys.function = aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_dynamics; // will be set just prior to the call to gsl_odeiv_evolve_apply()
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::pre_run_hook()
{
  B_.logger_.init();
...
extern "C" inline int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_dynamics(double __time, const double ode_state[], double f[], void* pnode)
{
  typedef aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::State_ State_;
  // get access to node so we can almost work as in a member function
  assert( pnode );
  const aeif_psc_alpha_neuron_Nestml_Plastic_Optimized& node = *( reinterpret_cast< aeif_psc_alpha_neuron_Nestml_Plastic_Optimized* >( pnode ) );

  // ode_state[] here is---and must be---the state vector supplied by the integrator,
  // not the state vector in the node, node.S_.ode_state[].
  f[State_::V_m] = (node.P_.Delta_T * node.P_.g_L * std::exp(((-node.P_.V_th) + std::min(ode_state[State_::V_m], node.P_.V_peak)) / node.P_.Delta_T) + node.P_.E_L * node.P_.g_L + node.P_.I_e + node.B_.I_stim_grid_sum_ - node.P_.g_L * std::min(ode_state[State_::V_m], node.P_.V_peak) + 1.0 * ode_state[State_::g_exc__X__exc_spikes] - 1.0 * ode_state[State_::g_inh__X__inh_spikes] - ode_state[State_::w]) / node.P_.C_m;
  f[State_::w] = (-node.P_.E_L) * node.P_.a / node.P_.tau_w + node.P_.a * std::min(ode_state[State_::V_m], node.P_.V_peak) / node.P_.tau_w - ode_state[State_::w] / node.P_.tau_w;
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::update(nest::Time const & origin,const long from, const long to)
{
...
#ifdef DEBUG
  std::cout << "In aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::update: t = " << __resolution << std::endl;
#endif
...
const double g_exc__X__exc_spikes__d__tmp_ = V_.__P__g_exc__X__exc_spikes__d__g_exc__X__exc_spikes * S_.ode_state[State_::g_exc__X__exc_spikes] + V_.__P__g_exc__X__exc_spikes__d__g_exc__X__exc_spikes__d * S_.ode_state[State_::g_exc__X__exc_spikes__d];
    ...
    **/
    ...
    {  
        ...
        // analytic solver: integrating state variables (first step): g_inh__X__inh_spikes, g_inh__X__inh_spikes__d, g_exc__X__exc_spikes, g_exc__X__exc_spikes__d, 
        ...
        double __t = 0;
        B_.__sys.function = aeif_psc_alpha_neuron_Nestml_Plastic_Optimized_dynamics;
        ...
        // analytic solver: integrating state variables (second step): g_inh__X__inh_spikes, g_inh__X__inh_spikes__d, g_exc__X__exc_spikes, g_exc__X__exc_spikes__d, 
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
