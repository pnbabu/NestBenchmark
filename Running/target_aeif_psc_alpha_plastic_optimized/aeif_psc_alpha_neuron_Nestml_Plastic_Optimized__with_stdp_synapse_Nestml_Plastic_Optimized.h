 ...
 *
 *  Generated from NESTML at time: 2024-03-11 16:30:14.577531
**/
#ifndef AEIF_PSC_ALPHA_NEURON_NESTML_PLASTIC_OPTIMIZED__WITH_STDP_SYNAPSE_NESTML_PLASTIC_OPTIMIZED
#define AEIF_PSC_ALPHA_NEURON_NESTML_PLASTIC_OPTIMIZED__WITH_STDP_SYNAPSE_NESTML_PLASTIC_OPTIMIZED
...
namespace nest
{
namespace aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names
{
    const Name _V_m( "V_m" );
    const Name _w( "w" );
...
**/
extern "C" inline int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_dynamics( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
...
extern "C" inline int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_dynamics_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized( double, const double ode_state[], double f[], void* pnode );
...
class histentry__aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized
{
public:
  histentry__aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized( double t,
...
/* BeginDocumentation
  Name: aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized
...
tau_syn_exc [ms]  synaptic parameters
...
*/
class aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
   ...
   * Destructor.
  **/
  ~aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized() override;
...
private:
  ...
  std::deque< histentry__aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized > history_;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized>;
  friend class nest::UniversalDataLogger<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized>;
...
bool is_refractory;
  ...
  **/
  struct Buffers_
  {
    Buffers_(aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized &);
    Buffers_(const Buffers_ &, aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized> logger_;
  ...
  {
    return S_.ode_state[State_::g_exc__X__exc_spikes] * 1.0;
  }

  inline double get_I_syn_inh() const
  {
    return S_.ode_state[State_::g_inh__X__inh_spikes] * 1.0;
  }
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized> recordablesMap_;
  friend int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_dynamics( double, const double ode_state[], double f[], void* pnode );
  friend int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_dynamics( double, const double ode_state[], double f[], void* pnode );

  friend int aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_dynamics_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized( double, const double ode_state[], double f[], void* pnode );

}; /* neuron aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized */

inline nest_port_t aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::get_status(DictionaryDatum &__d) const
{
  ...
  // parameters
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_C_m, get_C_m());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_refr_T, get_refr_T());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_reset, get_V_reset());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_L, get_g_L());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_E_L, get_E_L());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_a, get_a());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_b, get_b());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_Delta_T, get_Delta_T());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_w, get_tau_w());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_th, get_V_th());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_peak, get_V_peak());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_I_e, get_I_e());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic_Optimized, get_tau_tr_post__for_stdp_synapse_Nestml_Plastic_Optimized());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_m, get_V_m());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_w, get_w());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_refr_t, get_refr_t());
  def<bool>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_is_refractory, get_is_refractory());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized, get_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes, get_g_inh__X__inh_spikes());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes__d, get_g_inh__X__inh_spikes__d());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes, get_g_exc__X__exc_spikes());
  def<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes__d, get_g_exc__X__exc_spikes__d());
...
inline void aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_refr_T, tmp_refr_T, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_reset, tmp_V_reset, this);
  double tmp_g_L = get_g_L();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_L, tmp_g_L, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_E_L, tmp_E_L, this);
  double tmp_a = get_a();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_a, tmp_a, this);
  double tmp_b = get_b();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_b, tmp_b, this);
  double tmp_Delta_T = get_Delta_T();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_Delta_T, tmp_Delta_T, this);
  double tmp_tau_w = get_tau_w();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_w, tmp_tau_w, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_th, tmp_V_th, this);
  double tmp_V_peak = get_V_peak();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_peak, tmp_V_peak, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_I_e, tmp_I_e, this);
  ...
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic_Optimized, tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic_Optimized, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_V_m, tmp_V_m, this);
  double tmp_w = get_w();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_w, tmp_w, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_refr_t, tmp_refr_t, this);
  bool tmp_is_refractory = get_is_refractory();
  nest::updateValueParam<bool>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_is_refractory, tmp_is_refractory, this);
  ...
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized, tmp_post_trace__for_stdp_synapse_Nestml_Plastic_Optimized, this);
  double tmp_g_inh__X__inh_spikes = get_g_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes, tmp_g_inh__X__inh_spikes, this);
  double tmp_g_inh__X__inh_spikes__d = get_g_inh__X__inh_spikes__d();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_inh__X__inh_spikes__d, tmp_g_inh__X__inh_spikes__d, this);
  double tmp_g_exc__X__exc_spikes = get_g_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes, tmp_g_exc__X__exc_spikes, this);
  double tmp_g_exc__X__exc_spikes__d = get_g_exc__X__exc_spikes__d();
  nest::updateValueParam<double>(__d, nest::aeif_psc_alpha_neuron_Nestml_Plastic_Optimized__with_stdp_synapse_Nestml_Plastic_Optimized_names::_g_exc__X__exc_spikes__d, tmp_g_exc__X__exc_spikes__d, this);
...
#endif /* #ifndef AEIF_PSC_ALPHA_NEURON_NESTML_PLASTIC_OPTIMIZED__WITH_STDP_SYNAPSE_NESTML_PLASTIC_OPTIMIZED */
