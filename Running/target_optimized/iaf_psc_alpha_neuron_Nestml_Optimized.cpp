...
template <> void RecordablesMap<iaf_psc_alpha_neuron_Nestml_Optimized>::create()
  {
...
iaf_psc_alpha_neuron_Nestml_Optimized::Buffers_::Buffers_(iaf_psc_alpha_neuron_Nestml_Optimized &n):
  logger_(n)
...
iaf_psc_alpha_neuron_Nestml_Optimized::Buffers_::Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_Nestml_Optimized &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
iaf_psc_alpha_neuron_Nestml_Optimized::iaf_psc_alpha_neuron_Nestml_Optimized(const iaf_psc_alpha_neuron_Nestml_Optimized& __n):
