...
nestmlOptimizedmodule nestmlOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

nestmlOptimizedmodule::nestmlOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
nestmlOptimizedmodule::name() const
{
  return std::string("nestmlOptimizedmodule"); // Return name of the module
}
