...
#include "iaf_psc_alpha_nestmlmodule.h"
...
iaf_psc_alpha_nestmlmodule iaf_psc_alpha_nestmlmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_psc_alpha_nestmlmodule::iaf_psc_alpha_nestmlmodule()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_psc_alpha_nestmlmodule::name() const
{
  return std::string("iaf_psc_alpha_nestmlmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
iaf_psc_alpha_nestmlmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<iaf_psc_alpha_neuron_Nestml>("iaf_psc_alpha_neuron_Nestml");
    nest::kernel().model_manager.register_node_model<iaf_psc_alpha_neuron_Nestml>("iaf_psc_alpha_neuron_Nestml");
} // iaf_psc_alpha_nestmlmodule::init()