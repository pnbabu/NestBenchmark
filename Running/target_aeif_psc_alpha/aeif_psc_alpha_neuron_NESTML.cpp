...
namespace nest
{
  ...
  template <>
  void RecordablesMap<aeif_psc_alpha_neuron_NESTML>::create()
  {
...
aeif_psc_alpha_neuron_NESTML::aeif_psc_alpha_neuron_NESTML(const aeif_psc_alpha_neuron_NESTML &__n) : ArchivingNode(), P_(__n.P_), S_(__n.S_), B_(__n.B_, *this)
{
