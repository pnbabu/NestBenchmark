...
/*
*  aeif_psc_alpha_nestmlmodule.cpp
*
...
#include "aeif_psc_alpha_nestmlmodule.h"
...
aeif_psc_alpha_nestmlmodule aeif_psc_alpha_nestmlmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

aeif_psc_alpha_nestmlmodule::aeif_psc_alpha_nestmlmodule()
{
#ifdef LINKED_MODULE
...
const std::string
aeif_psc_alpha_nestmlmodule::name() const
{
  return std::string("aeif_psc_alpha_nestmlmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
aeif_psc_alpha_nestmlmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<aeif_psc_alpha_neuron_NESTML>("aeif_psc_alpha_neuron_NESTML");
} // aeif_psc_alpha_nestmlmodule::init()