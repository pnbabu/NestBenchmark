...
/**
 *  aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic.h
 *
...
**/
#ifndef AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC__WITH_STDP_SYNAPSE_NESTML_PLASTIC
#define AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC__WITH_STDP_SYNAPSE_NESTML_PLASTIC
...
namespace nest
{
namespace aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names
{
    const Name _V_m( "V_m" );
    const Name _w( "w" );
    ...
    const Name _I_e( "I_e" );
    const Name _tau_tr_post__for_stdp_synapse_Nestml_Plastic( "tau_tr_post__for_stdp_synapse_Nestml_Plastic" );
}
}
...
**/
extern "C" inline int aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_dynamics( double, const double ode_state[], double f[], void* pnode );
/**
 * Function computing right-hand side of ODE for GSL solver.
 * @note Must be declared here so we can befriend it in class.
 * @note Must have C-linkage for passing to GSL. Internally, it is
...
extern "C" inline int aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_dynamics_post_trace__for_stdp_synapse_Nestml_Plastic( double, const double ode_state[], double f[], void* pnode );
...
class histentry__aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic
{
public:
  histentry__aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic( double t,
double post_trace__for_stdp_synapse_Nestml_Plastic,
size_t access_counter )
  : t_( t )
  , post_trace__for_stdp_synapse_Nestml_Plastic_( post_trace__for_stdp_synapse_Nestml_Plastic )
  , access_counter_( access_counter )
  {
  }

  double t_;              //!< point in time when spike occurred (in ms)
   double post_trace__for_stdp_synapse_Nestml_Plastic_;
  size_t access_counter_; //!< access counter to enable removal of the entry, once all neurons read it
};

/* BeginDocumentation
  Name: aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic
...
*/
class aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic(const aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);

  /**
   * Destructor.
  **/
  ~aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic() override;
  ...
  **/
  ...
  inline double get_post_trace__for_stdp_synapse_Nestml_Plastic() const
  {
    return S_.ode_state[State_::post_trace__for_stdp_synapse_Nestml_Plastic];
  }

  inline void set_post_trace__for_stdp_synapse_Nestml_Plastic(const double __v)
  {
    S_.ode_state[State_::post_trace__for_stdp_synapse_Nestml_Plastic] = __v;
  }
  ...
  inline double get_tau_tr_post__for_stdp_synapse_Nestml_Plastic() const
  {
    return P_.tau_tr_post__for_stdp_synapse_Nestml_Plastic;
  }

  inline void set_tau_tr_post__for_stdp_synapse_Nestml_Plastic(const double __v)
  {
    P_.tau_tr_post__for_stdp_synapse_Nestml_Plastic = __v;
  }
  ...
  double get_post_trace__for_stdp_synapse_Nestml_Plastic( double t, const bool before_increment = true );
...
private:
  ...
  std::deque< histentry__aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic > history_;

  // cache for initial values
  double post_trace__for_stdp_synapse_Nestml_Plastic__iv;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>;
  friend class nest::UniversalDataLogger<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>;
  ...
  **/
  ...
  {    
    ...
    double I_e;
    double tau_tr_post__for_stdp_synapse_Nestml_Plastic;
...
bool is_refractory;
    ...
    enum StateVecElems
    {
      ...
      post_trace__for_stdp_synapse_Nestml_Plastic,
  ...
  **/
  struct Buffers_
  {
    Buffers_(aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);
    Buffers_(const Buffers_ &, aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic> recordablesMap_;
  friend int aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_dynamics( double, const double ode_state[], double f[], void* pnode );
  friend int aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_dynamics( double, const double ode_state[], double f[], void* pnode );

  friend int aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_dynamics_post_trace__for_stdp_synapse_Nestml_Plastic( double, const double ode_state[], double f[], void* pnode );

}; /* neuron aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic */

inline nest_port_t aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::get_status(DictionaryDatum &__d) const
{
  ...
  // parameters
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_C_m, get_C_m());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_T, get_refr_T());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_reset, get_V_reset());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_L, get_g_L());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_L, get_E_L());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_a, get_a());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_b, get_b());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_Delta_T, get_Delta_T());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_w, get_tau_w());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_th, get_V_th());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_peak, get_V_peak());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_exc, get_E_exc());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_inh, get_E_inh());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_I_e, get_I_e());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic, get_tau_tr_post__for_stdp_synapse_Nestml_Plastic());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_m, get_V_m());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_w, get_w());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_t, get_refr_t());
  def<bool>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_is_refractory, get_is_refractory());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_post_trace__for_stdp_synapse_Nestml_Plastic, get_post_trace__for_stdp_synapse_Nestml_Plastic());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_exc__X__exc_spikes, get_g_exc__X__exc_spikes());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_exc__X__exc_spikes__d, get_g_exc__X__exc_spikes__d());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_inh__X__inh_spikes, get_g_inh__X__inh_spikes());
  def<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_inh__X__inh_spikes__d, get_g_inh__X__inh_spikes__d());
...
inline void aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_C_m, tmp_C_m, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_T, tmp_refr_T, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_reset, tmp_V_reset, this);
  double tmp_g_L = get_g_L();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_L, tmp_g_L, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_L, tmp_E_L, this);
  double tmp_a = get_a();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_a, tmp_a, this);
  double tmp_b = get_b();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_b, tmp_b, this);
  double tmp_Delta_T = get_Delta_T();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_Delta_T, tmp_Delta_T, this);
  double tmp_tau_w = get_tau_w();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_w, tmp_tau_w, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_th, tmp_V_th, this);
  double tmp_V_peak = get_V_peak();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_peak, tmp_V_peak, this);
  double tmp_E_exc = get_E_exc();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_exc, tmp_E_exc, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_E_inh = get_E_inh();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_inh, tmp_E_inh, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_I_e, tmp_I_e, this);
  double tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic = get_tau_tr_post__for_stdp_synapse_Nestml_Plastic();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic, tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_m, tmp_V_m, this);
  double tmp_w = get_w();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_w, tmp_w, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_t, tmp_refr_t, this);
  bool tmp_is_refractory = get_is_refractory();
  nest::updateValueParam<bool>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_is_refractory, tmp_is_refractory, this);
  double tmp_post_trace__for_stdp_synapse_Nestml_Plastic = get_post_trace__for_stdp_synapse_Nestml_Plastic();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_post_trace__for_stdp_synapse_Nestml_Plastic, tmp_post_trace__for_stdp_synapse_Nestml_Plastic, this);
  double tmp_g_exc__X__exc_spikes = get_g_exc__X__exc_spikes();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_exc__X__exc_spikes, tmp_g_exc__X__exc_spikes, this);
  double tmp_g_exc__X__exc_spikes__d = get_g_exc__X__exc_spikes__d();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_exc__X__exc_spikes__d, tmp_g_exc__X__exc_spikes__d, this);
  double tmp_g_inh__X__inh_spikes = get_g_inh__X__inh_spikes();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_inh__X__inh_spikes, tmp_g_inh__X__inh_spikes, this);
  double tmp_g_inh__X__inh_spikes__d = get_g_inh__X__inh_spikes__d();
  nest::updateValueParam<double>(__d, nest::aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_g_inh__X__inh_spikes__d, tmp_g_inh__X__inh_spikes__d, this);
  ...
  set_I_e(tmp_I_e);
  set_tau_tr_post__for_stdp_synapse_Nestml_Plastic(tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic);
  set_V_m(tmp_V_m);
  set_w(tmp_w);
  set_refr_t(tmp_refr_t);
...
#endif /* #ifndef AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC__WITH_STDP_SYNAPSE_NESTML_PLASTIC */
