/**
 *  stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic.h
 *
 ...
 *
 *  Generated from NESTML at time: 2024-03-11 15:33:31.926693
**/

#ifndef STDP_SYNAPSE_NESTML_PLASTIC__WITH_AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC_H
#define STDP_SYNAPSE_NESTML_PLASTIC__WITH_AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC_H
...
namespace stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names
{
    const Name _w( "w" );
...
class stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties : public CommonSynapseProperties {
public:

    stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties()
...
class stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic : public Connection< targetidentifierT >
{
  typedef aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic post_neuron_t;
...
private:
  ...
  **/
  inline void
  update_internal_state_(double t_start, double timestep, const stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties& cp);

  void recompute_internal_variables();

public:
  // this line determines which common properties to use
  typedef stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties CommonPropertiesType;
  ...
  */
  stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic();
  ...
  */
  stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic( const stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic& rhs );
  ...
  **/
    ...
    const CommonPropertiesType& cp )
  {
    ...
    try {
      dynamic_cast<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic&>(t);
    }
    catch (std::bad_cast &exp) {
      std::cout << "wrong type of neuron connected! Synapse 'stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic' will only work with neuron 'aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic'.\n";
      exit(1);
    }
  ...
  bool
  send( Event& e, const size_t tid, const stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties& cp )
...
#ifdef DEBUG
    std::cout << "stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic::send(): handling pre spike at t = " << __t_spike << std::endl;
#endif
    // use accessor functions (inherited from Connection< >) to obtain delay and target
    aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic* __target = static_cast<aeif_cond_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic*>(get_target(tid));
    assert(__target);
...
template < typename targetidentifierT >
constexpr ConnectionModelProperties stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::properties;


template < typename targetidentifierT >
void
stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_lambda, get_lambda());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_tau_tr_pre, get_tau_tr_pre());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_tau_tr_post, get_tau_tr_post());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_alpha, get_alpha());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_mu_plus, get_mu_plus());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_mu_minus, get_mu_minus());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_Wmax, get_Wmax());  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_Wmin, get_Wmin());

  // initial values for state variables in ODE or kernel  
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_w, get_w());
  // special treatment for variable marked with @nest::name decorator
  def<double>(__d, names::weight, get_w());
  def<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_pre_trace, get_pre_trace());
}

template < typename targetidentifierT >
void
stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::set_status( const DictionaryDatum& __d,
  ConnectorModel& cm )
{
  // parameters  
  double tmp_d = get_d();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_d, tmp_d);  
  double tmp_lambda = get_lambda();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_lambda, tmp_lambda);  
  double tmp_tau_tr_pre = get_tau_tr_pre();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_tau_tr_pre, tmp_tau_tr_pre);  
  double tmp_tau_tr_post = get_tau_tr_post();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_tau_tr_post, tmp_tau_tr_post);  
  double tmp_alpha = get_alpha();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_alpha, tmp_alpha);  
  double tmp_mu_plus = get_mu_plus();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_mu_plus, tmp_mu_plus);  
  double tmp_mu_minus = get_mu_minus();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_mu_minus, tmp_mu_minus);  
  double tmp_Wmax = get_Wmax();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_Wmax, tmp_Wmax);  
  double tmp_Wmin = get_Wmin();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_Wmin, tmp_Wmin);

  // initial values for state variables in ODE or kernel  
  double tmp_w = get_w();
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_w, tmp_w);
  ...
  updateValue<double>(__d, nest::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic_names::_pre_trace, tmp_pre_trace);
...
**/
template < typename targetidentifierT >
void stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::recompute_internal_variables()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic() : ConnectionBase()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
P_.d = 1; // as ms
...
**/
template < typename targetidentifierT >
stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic( const stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >& rhs )
: ConnectionBase( rhs )
{
    P_.d = rhs.P_.d;
...
template < typename targetidentifierT >
inline void
stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_Plastic< targetidentifierT >::update_internal_state_(double t_start, double timestep, const stdp_synapse_Nestml_Plastic__with_aeif_cond_alpha_neuron_Nestml_PlasticCommonSynapseProperties& cp)
{
    if (timestep < 1E-12)
    {
#ifdef DEBUG
...
#endif /* #ifndef STDP_SYNAPSE_NESTML_PLASTIC__WITH_AEIF_COND_ALPHA_NEURON_NESTML_PLASTIC_H */