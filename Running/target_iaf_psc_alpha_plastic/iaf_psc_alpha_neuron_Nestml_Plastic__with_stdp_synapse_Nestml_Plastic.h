 ...
 *
 *  Generated from NESTML at time: 2024-03-11 15:32:30.558001
**/
...
namespace nest
{
namespace iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names
{
    const Name _V_m( "V_m" );
...
class histentry__iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic
{
public:
  histentry__iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic( double t,
...
/* BeginDocumentation
  Name: iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic
...
*/
class iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic(const iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);

  /**
   * Destructor.
  **/
  ~iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic() override;
...
private:
  ...
  std::deque< histentry__iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic > history_;
...
static std::vector< std::tuple< int, int > > rport_to_nestml_buffer_idx;
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>;
  friend class nest::UniversalDataLogger<iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);
    Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic> logger_;
...
inline nest::RingBuffer& get_I_stim() {
  ...
  static nest::RecordablesMap<iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic> recordablesMap_;

}; /* neuron iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic */

inline nest_port_t iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::send_test_event(nest::Node& target, nest_rport_t receptor_type, nest::synindex, bool)
{
...
inline nest_port_t iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::SpikeEvent&, nest_port_t receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest_port_t iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::CurrentEvent&, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest_port_t iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::handles_test_event(nest::DataLoggingRequest& dlr, nest_port_t receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::get_status(DictionaryDatum &__d) const
{
  ...
  // parameters
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_C_m, get_C_m());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_m, get_tau_m());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_inh, get_tau_syn_inh());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_exc, get_tau_syn_exc());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_T, get_refr_T());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_L, get_E_L());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_reset, get_V_reset());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_th, get_V_th());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_I_e, get_I_e());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic, get_tau_tr_post__for_stdp_synapse_Nestml_Plastic());

  // initial values for state variables in ODE or kernel
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_m, get_V_m());
  def<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_t, get_refr_t());
...
inline void iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::set_status(const DictionaryDatum &__d)
{
  // parameters
  double tmp_C_m = get_C_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_C_m, tmp_C_m, this);
  double tmp_tau_m = get_tau_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_m, tmp_tau_m, this);
  double tmp_tau_syn_inh = get_tau_syn_inh();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_inh, tmp_tau_syn_inh, this);
  double tmp_tau_syn_exc = get_tau_syn_exc();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_syn_exc, tmp_tau_syn_exc, this);
  double tmp_refr_T = get_refr_T();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_T, tmp_refr_T, this);
  double tmp_E_L = get_E_L();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_E_L, tmp_E_L, this);
  double tmp_V_reset = get_V_reset();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_reset, tmp_V_reset, this);
  double tmp_V_th = get_V_th();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_th, tmp_V_th, this);
  double tmp_I_e = get_I_e();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_I_e, tmp_I_e, this);
  double tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic = get_tau_tr_post__for_stdp_synapse_Nestml_Plastic();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_tau_tr_post__for_stdp_synapse_Nestml_Plastic, tmp_tau_tr_post__for_stdp_synapse_Nestml_Plastic, this);

  // initial values for state variables in ODE or kernel
  double tmp_V_m = get_V_m();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_V_m, tmp_V_m, this);
  double tmp_refr_t = get_refr_t();
  nest::updateValueParam<double>(__d, nest::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic_names::_refr_t, tmp_refr_t, this);
...
#endif /* #ifndef IAF_PSC_ALPHA_NEURON_NESTML_PLASTIC__WITH_STDP_SYNAPSE_NESTML_PLASTIC */
