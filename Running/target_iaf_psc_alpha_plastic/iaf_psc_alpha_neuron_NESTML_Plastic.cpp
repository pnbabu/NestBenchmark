...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<iaf_psc_alpha_neuron_NESTML_Plastic> iaf_psc_alpha_neuron_NESTML_Plastic::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<iaf_psc_alpha_neuron_NESTML_Plastic>::create()
  {
    // add state variables to recordables map
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_V_m, &iaf_psc_alpha_neuron_NESTML_Plastic::get_V_m);
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_refr_t, &iaf_psc_alpha_neuron_NESTML_Plastic::get_refr_t);
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_I_kernel_inh__X__inh_spikes, &iaf_psc_alpha_neuron_NESTML_Plastic::get_I_kernel_inh__X__inh_spikes);
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_I_kernel_inh__X__inh_spikes__d, &iaf_psc_alpha_neuron_NESTML_Plastic::get_I_kernel_inh__X__inh_spikes__d);
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_I_kernel_exc__X__exc_spikes, &iaf_psc_alpha_neuron_NESTML_Plastic::get_I_kernel_exc__X__exc_spikes);
   insert_(iaf_psc_alpha_neuron_NESTML_Plastic_names::_I_kernel_exc__X__exc_spikes__d, &iaf_psc_alpha_neuron_NESTML_Plastic::get_I_kernel_exc__X__exc_spikes__d);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > iaf_psc_alpha_neuron_NESTML_Plastic::rport_to_nestml_buffer_idx =
{
  
  { iaf_psc_alpha_neuron_NESTML_Plastic::EXC_SPIKES, iaf_psc_alpha_neuron_NESTML_Plastic::INH_SPIKES },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of iaf_psc_alpha_neuron_NESTML_Plastic's constructor.
// ---------------------------------------------------------------------------

iaf_psc_alpha_neuron_NESTML_Plastic::Parameters_::Parameters_()
{
}

iaf_psc_alpha_neuron_NESTML_Plastic::State_::State_()
{
}
...
iaf_psc_alpha_neuron_NESTML_Plastic::Buffers_::Buffers_(iaf_psc_alpha_neuron_NESTML_Plastic &n):
  logger_(n)
...
iaf_psc_alpha_neuron_NESTML_Plastic::Buffers_::Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_NESTML_Plastic &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
iaf_psc_alpha_neuron_NESTML_Plastic::iaf_psc_alpha_neuron_NESTML_Plastic():ArchivingNode(), P_(), S_(), B_(*this)
{
...
iaf_psc_alpha_neuron_NESTML_Plastic::iaf_psc_alpha_neuron_NESTML_Plastic(const iaf_psc_alpha_neuron_NESTML_Plastic& __n):
...
iaf_psc_alpha_neuron_NESTML_Plastic::~iaf_psc_alpha_neuron_NESTML_Plastic()
{
}
...
// ---------------------------------------------------------------------------
void iaf_psc_alpha_neuron_NESTML_Plastic::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void iaf_psc_alpha_neuron_NESTML_Plastic::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic::init_state_internal_()" << std::endl;
#endif
...
void iaf_psc_alpha_neuron_NESTML_Plastic::init_buffers_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void iaf_psc_alpha_neuron_NESTML_Plastic::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void iaf_psc_alpha_neuron_NESTML_Plastic::pre_run_hook()
{
  B_.logger_.init();
...
void iaf_psc_alpha_neuron_NESTML_Plastic::update(nest::Time const & origin,const long from, const long to)
{
...
#ifdef DEBUG
  std::cout << "In iaf_psc_alpha_neuron_NESTML_Plastic::update: t = " << __resolution << std::endl;
#endif
...
void iaf_psc_alpha_neuron_NESTML_Plastic::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void iaf_psc_alpha_neuron_NESTML_Plastic::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == iaf_psc_alpha_neuron_NESTML_Plastic::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void iaf_psc_alpha_neuron_NESTML_Plastic::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
