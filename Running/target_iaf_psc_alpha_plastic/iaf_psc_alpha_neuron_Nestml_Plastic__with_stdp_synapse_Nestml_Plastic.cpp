...
template <> void RecordablesMap<iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic>::create()
  {
...
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::Buffers_::Buffers_(iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &n):
  logger_(n)
...
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::Buffers_::Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic(const iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic& __n):
...
const double I_kernel_inh__X__inh_spikes__d__tmp_ = S_.I_kernel_inh__X__inh_spikes * V_.__P__I_kernel_inh__X__inh_spikes__d__I_kernel_inh__X__inh_spikes + S_.I_kernel_inh__X__inh_spikes__d * V_.__P__I_kernel_inh__X__inh_spikes__d__I_kernel_inh__X__inh_spikes__d;
    ...
    **/
    ...
    {  
        ...
        // analytic solver: integrating state variables (first step): V_m, I_kernel_exc__X__exc_spikes, I_kernel_exc__X__exc_spikes__d, I_kernel_inh__X__inh_spikes, I_kernel_inh__X__inh_spikes__d, post_trace__for_stdp_synapse_Nestml_Plastic, 
        ...
        // analytic solver: integrating state variables (second step): V_m, I_kernel_exc__X__exc_spikes, I_kernel_exc__X__exc_spikes__d, I_kernel_inh__X__inh_spikes, I_kernel_inh__X__inh_spikes__d, post_trace__for_stdp_synapse_Nestml_Plastic, 
...
void
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::register_stdp_connection( double t_first_read, double delay )
{
...
void
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::get_history__( double t1,
  double t2,
...
void
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::set_spiketime( nest::Time const& t_sp, double offset )
{
...
S_.post_trace__for_stdp_synapse_Nestml_Plastic += 1;
    ...
    **/
    ...
    last_spike_ = t_sp_ms;
    history_.push_back( histentry__iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic( last_spike_
...
void
iaf_psc_alpha_neuron_Nestml_Plastic__with_stdp_synapse_Nestml_Plastic::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
