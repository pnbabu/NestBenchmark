...
iaf_psc_alpha_nestmlplasticmodule iaf_psc_alpha_nestmlplasticmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_psc_alpha_nestmlplasticmodule::iaf_psc_alpha_nestmlplasticmodule()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_psc_alpha_nestmlplasticmodule::name() const
{
  return std::string("iaf_psc_alpha_nestmlplasticmodule"); // Return name of the module
}
