// #define DEBUG 1
/*
 *  iaf_psc_alpha_neuron_Nestml_Plastic_Optimized.cpp
 *
...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<iaf_psc_alpha_neuron_Nestml_Plastic_Optimized> iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<iaf_psc_alpha_neuron_Nestml_Plastic_Optimized>::create()
  {
    // add state variables to recordables map
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_V_m, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_V_m);
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_refr_t, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_refr_t);
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_I_kernel_inh__X__inh_spikes, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_I_kernel_inh__X__inh_spikes);
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_I_kernel_inh__X__inh_spikes__d, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_I_kernel_inh__X__inh_spikes__d);
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_I_kernel_exc__X__exc_spikes, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_I_kernel_exc__X__exc_spikes);
   insert_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized_names::_I_kernel_exc__X__exc_spikes__d, &iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::get_I_kernel_exc__X__exc_spikes__d);

    // Add vector variables  
  }
}
std::vector< std::tuple< int, int > > iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::rport_to_nestml_buffer_idx =
{
  
  { iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::EXC_SPIKES, iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::INH_SPIKES },
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of iaf_psc_alpha_neuron_Nestml_Plastic_Optimized's constructor.
// ---------------------------------------------------------------------------

iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::Parameters_::Parameters_()
{
}

iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::State_::State_()
{
}
...
iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::Buffers_::Buffers_(iaf_psc_alpha_neuron_Nestml_Plastic_Optimized &n):
  logger_(n)
...
iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::Buffers_::Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_Nestml_Plastic_Optimized &n):
  logger_(n)
  , spike_inputs_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
  , spike_inputs_grid_sum_( std::vector< double >( NUM_SPIKE_RECEPTORS ) )
  , spike_input_received_( std::vector< nest::RingBuffer >( NUM_SPIKE_RECEPTORS ) )
...
iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::iaf_psc_alpha_neuron_Nestml_Plastic_Optimized():ArchivingNode(), P_(), S_(), B_(*this)
{
...
iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::iaf_psc_alpha_neuron_Nestml_Plastic_Optimized(const iaf_psc_alpha_neuron_Nestml_Plastic_Optimized& __n):
...
iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::~iaf_psc_alpha_neuron_Nestml_Plastic_Optimized()
{
}
...
// ---------------------------------------------------------------------------
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::calibrate_time( const nest::TimeConverter& tc )
{
  LOG( nest::M_WARNING,
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::init_state_internal_()" << std::endl;
#endif
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::init_buffers_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::pre_run_hook()
{
  B_.logger_.init();
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::update(nest::Time const & origin,const long from, const long to)
{
...
#ifdef DEBUG
  std::cout << "In iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::update: t = " << __resolution << std::endl;
#endif
...
const double I_kernel_exc__X__exc_spikes__d__tmp_ = S_.I_kernel_exc__X__exc_spikes * V_.__P__I_kernel_exc__X__exc_spikes__d__I_kernel_exc__X__exc_spikes + S_.I_kernel_exc__X__exc_spikes__d * V_.__P__I_kernel_exc__X__exc_spikes__d__I_kernel_exc__X__exc_spikes__d;
    ...
    **/
    ...
    {  
        ...
        // analytic solver: integrating state variables (first step): V_m, I_kernel_inh__X__inh_spikes, I_kernel_inh__X__inh_spikes__d, I_kernel_exc__X__exc_spikes, I_kernel_exc__X__exc_spikes__d, 
        ...
        // analytic solver: integrating state variables (second step): V_m, I_kernel_inh__X__inh_spikes, I_kernel_inh__X__inh_spikes__d, I_kernel_exc__X__exc_spikes, I_kernel_exc__X__exc_spikes__d, 
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}


void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if ( nestml_buffer_idx == iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::PORT_NOT_AVAILABLE )
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void iaf_psc_alpha_neuron_Nestml_Plastic_Optimized::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
