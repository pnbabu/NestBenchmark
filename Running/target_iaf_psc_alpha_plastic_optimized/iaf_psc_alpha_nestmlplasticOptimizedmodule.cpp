...
iaf_psc_alpha_nestmlplasticOptimizedmodule iaf_psc_alpha_nestmlplasticOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_psc_alpha_nestmlplasticOptimizedmodule::iaf_psc_alpha_nestmlplasticOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_psc_alpha_nestmlplasticOptimizedmodule::name() const
{
  return std::string("iaf_psc_alpha_nestmlplasticOptimizedmodule"); // Return name of the module
}
