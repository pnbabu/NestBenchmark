// #define DEBUG 1
/*
 *  iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized.cpp
 *
...
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized> iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::recordablesMap_;
namespace nest
{
  ...
  template <>
  void RecordablesMap<iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized>::create()
  {
...
std::vector<std::tuple<int, int>> iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::rport_to_nestml_buffer_idx =
    {

        {iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::EXC_SPIKES, iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::INH_SPIKES},
};

// ---------------------------------------------------------------------------
//   Default constructors defining default parameters and state
//   Note: the implementation is empty. The initialization is of variables
//   is a part of iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized's constructor.
// ---------------------------------------------------------------------------

iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::Parameters_::Parameters_()
{
}

iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::State_::State_()
{
}
...
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::Buffers_::Buffers_(iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized &n) : logger_(n), spike_inputs_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_inputs_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), spike_input_received_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_input_received_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS))
{
  // Initialization of the remaining members is deferred to init_buffers_().
}

iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::Buffers_::Buffers_(const Buffers_ &, iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized &n) : logger_(n), spike_inputs_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_inputs_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS)), spike_input_received_(std::vector<nest::RingBuffer>(NUM_SPIKE_RECEPTORS)), spike_input_received_grid_sum_(std::vector<double>(NUM_SPIKE_RECEPTORS))
{
  // Initialization of the remaining members is deferred to init_buffers_().
}
...
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized() : ArchivingNode(), P_(), S_(), B_(*this)
{
...
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized(const iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized &__n) : ArchivingNode(), P_(__n.P_), S_(__n.S_), B_(__n.B_, *this)
{
  ...
  post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__iv = S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized;
}
...
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::~iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized()
{
}
...
// ---------------------------------------------------------------------------
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::calibrate_time(const nest::TimeConverter &tc)
{
  LOG(nest::M_WARNING,
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::init_state_internal_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::init_state_internal_()" << std::endl;
#endif
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::init_buffers_()
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::init_buffers_()" << std::endl;
#endif
  // spike input buffers
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::recompute_internal_variables(bool exclude_timestep)
{
  const double __resolution = nest::Time::get_resolution().get_ms(); // do not remove, this is necessary for the resolution() function
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::update(nest::Time const &origin, const long from, const long to)
{
...
#ifdef DEBUG
  std::cout << "In iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::update: t = " << __resolution << std::endl;
#endif
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::handle(nest::DataLoggingRequest &e)
{
  B_.logger_.handle(e);
}

void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::handle(nest::SpikeEvent &e)
{
  ...
  else
  {
    ...
    if (nestml_buffer_idx == iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::PORT_NOT_AVAILABLE)
    {
      nestml_buffer_idx = std::get<0>(rport_to_nestml_buffer_idx[e.get_rport()]);
    }
    weight = -weight;
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::handle(nest::CurrentEvent &e)
{
  assert(e.get_delay_steps() > 0);
...
inline double
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_spiketime_ms() const
{
  return last_spike_;
}

void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::register_stdp_connection(double t_first_read, double delay)
{
  ...
  for (std::deque<histentry__iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized>::iterator runner = history_.begin();
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_history__(double t1,
                                                                                                              double t2,
                                                                                                              ...
                                                                                                              std::deque<histentry__iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized>::iterator *finish)
{
  *finish = history_.end();
  ...
  std::deque<histentry__iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized>::reverse_iterator runner = history_.rbegin();
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::set_spiketime(nest::Time const &t_sp, double offset)
{
  ...
  if (n_incoming_)
  {
    ...
    if (history_.size() > 0)
    {
      ...
      S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = history_.back().post_trace__for_stdp_synapse_NESTML_Plastic_Optimized_;
    }
    else
    {
      S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = 0.0; // initial value for convolution is always 0
    }
    ...
    const double prev_h = t_sp_ms - last_spike_;
    if (prev_h > 1E-12)
    {
     ...
     **/
    S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized += 1;
    ...
    last_spike_ = t_sp_ms;
    history_.push_back(histentry__iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized(last_spike_, get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized(), 0));
  }
  else
  {
    last_spike_ = t_sp_ms;
...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
...
double
iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized(double t, const bool before_increment)
{
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: getting value at t = " << t << std::endl;
#endif
  ...
  {
#ifdef DEBUG
    std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: \thistory empty, returning initial value = " << post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__iv << std::endl;
#endif
  ...
  while (i >= 0)
  {
    ...
    {
#ifdef DEBUG
      std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: \tspike occurred at history[i].t_ = " << history_[i].t_ << std::endl;
#endif
      S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = history_[i].post_trace__for_stdp_synapse_NESTML_Plastic_Optimized_;
      ...
      if (prev_h >= nest::kernel().connection_manager.get_stdp_eps())
      {
        ...
        // analytic solver: integrating state variables (first step): post_trace__for_stdp_synapse_NESTML_Plastic_Optimized,
        const double post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__tmp = __P__post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__post_trace__for_stdp_synapse_NESTML_Plastic_Optimized_prev * S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized;
        // analytic solver: integrating state variables (second step): post_trace__for_stdp_synapse_NESTML_Plastic_Optimized,
        /* replace analytically solvable variables with precisely integrated values  */
        S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__tmp;
      }
...
#ifdef DEBUG
      std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: \treturning " << S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized << std::endl;
#endif
      return S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized; // type: double
    }
    --i;
  }
  ...
  {
    S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = history_[0].post_trace__for_stdp_synapse_NESTML_Plastic_Optimized_;

#ifdef DEBUG
    std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: \ttrace requested at exact time of history entry 0, returning " << S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized << std::endl;
#endif
...
#ifdef DEBUG
  std::cout << "iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::get_post_trace__for_stdp_synapse_NESTML_Plastic_Optimized: \tfall-through, returning initial value = " << post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__iv << std::endl;
#endif
  ...
  S_.post_trace__for_stdp_synapse_NESTML_Plastic_Optimized = 0.; // initial value for convolution is always 0
