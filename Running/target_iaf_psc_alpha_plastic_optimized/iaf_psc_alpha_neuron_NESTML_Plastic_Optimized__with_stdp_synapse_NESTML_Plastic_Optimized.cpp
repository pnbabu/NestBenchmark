...
void iaf_psc_alpha_neuron_NESTML_Plastic_Optimized__with_stdp_synapse_NESTML_Plastic_Optimized::set_spiketime(nest::Time const &t_sp, double offset)
{
  ...
  if (n_incoming_)
  {
    ...
    if (prev_h > 1E-12)
    {
      ...
      inline const double post_trace__for_stdp_synapse_NESTML_Plastic_Optimized__post_trace__for_stdp_synapse_NESTML_Plastic_Optimized_prev = 1.0 * std::exp((-V_.__h) / P_.tau_tr_post__for_stdp_synapse_NESTML_Plastic_Optimized);
