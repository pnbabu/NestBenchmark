...
PATHTOFILE = "/p/home/jusers/linssen1/jusuf/NestBenchmark/Running/examples/brunel_alpha_nest.py"
PATHTOSHFILE = "/p/home/jusers/linssen1/jusuf/NestBenchmark/Running/start.sh"

NEURONMODELS = ["iaf_psc_alpha_neuron_Nestml","iaf_psc_alpha"]
#NEURONMODELS = ["iaf_psc_alpha"]
NETWORKSCALES = np.logspace(2, 4, 3, dtype=int)
THREADS = 8
ITERATIONS=2
