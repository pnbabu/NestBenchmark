...
#include "aeif_psc_alpha_nestmlOptimizedmodule.h"
...
aeif_psc_alpha_nestmlOptimizedmodule aeif_psc_alpha_nestmlOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

aeif_psc_alpha_nestmlOptimizedmodule::aeif_psc_alpha_nestmlOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
aeif_psc_alpha_nestmlOptimizedmodule::name() const
{
  return std::string("aeif_psc_alpha_nestmlOptimizedmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
aeif_psc_alpha_nestmlOptimizedmodule::init( SLIInterpreter* i )
{
    // register neurons
...
} // aeif_psc_alpha_nestmlOptimizedmodule::init()