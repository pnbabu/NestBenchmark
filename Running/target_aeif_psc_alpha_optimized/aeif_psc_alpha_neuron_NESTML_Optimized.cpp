...
namespace nest
{
  ...
  template <>
  void RecordablesMap<aeif_psc_alpha_neuron_NESTML_Optimized>::create()
  {
...
aeif_psc_alpha_neuron_NESTML_Optimized::aeif_psc_alpha_neuron_NESTML_Optimized(const aeif_psc_alpha_neuron_NESTML_Optimized &__n) : ArchivingNode(), P_(__n.P_), S_(__n.S_), B_(__n.B_, *this)
{
