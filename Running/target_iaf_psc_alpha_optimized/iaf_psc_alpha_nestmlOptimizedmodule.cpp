...
#include "iaf_psc_alpha_nestmlOptimizedmodule.h"
...
iaf_psc_alpha_nestmlOptimizedmodule iaf_psc_alpha_nestmlOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

iaf_psc_alpha_nestmlOptimizedmodule::iaf_psc_alpha_nestmlOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
iaf_psc_alpha_nestmlOptimizedmodule::name() const
{
  return std::string("iaf_psc_alpha_nestmlOptimizedmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
iaf_psc_alpha_nestmlOptimizedmodule::init( SLIInterpreter* i )
{
    // register neurons
...
} // iaf_psc_alpha_nestmlOptimizedmodule::init()