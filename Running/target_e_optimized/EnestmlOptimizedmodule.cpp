...
#include "EnestmlOptimizedmodule.h"
...
EnestmlOptimizedmodule EnestmlOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

EnestmlOptimizedmodule::EnestmlOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
EnestmlOptimizedmodule::name() const
{
  return std::string("EnestmlOptimizedmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
EnestmlOptimizedmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<iaf_psc_exp_neuron_Nestml_Optimized>("iaf_psc_exp_neuron_Nestml_Optimized");
} // EnestmlOptimizedmodule::init()