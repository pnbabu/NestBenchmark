...
/*
*  aeif_cond_alpha_nestmlOptimizedmodule.cpp
*
...
#include "aeif_cond_alpha_nestmlOptimizedmodule.h"
...
aeif_cond_alpha_nestmlOptimizedmodule aeif_cond_alpha_nestmlOptimizedmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

aeif_cond_alpha_nestmlOptimizedmodule::aeif_cond_alpha_nestmlOptimizedmodule()
{
#ifdef LINKED_MODULE
...
const std::string
aeif_cond_alpha_nestmlOptimizedmodule::name() const
{
  return std::string("aeif_cond_alpha_nestmlOptimizedmodule"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
aeif_cond_alpha_nestmlOptimizedmodule::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<aeif_cond_alpha_neuron_Nestml_Optimized>("aeif_cond_alpha_neuron_Nestml_Optimized");
} // aeif_cond_alpha_nestmlOptimizedmodule::init()